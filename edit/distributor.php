...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","edit/getdistributor.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
<form class="form-horizontal" action="update/distributor.php">
        ...
        <div class="col-sm-6">
            <select class="form-control" name="id" required onchange="showUser(this.value)">
                ...
                if ($result->num_rows > 0) {
                    $count = 0;
                    echo "<option value = '' >Select an Distributor ID</option>";
